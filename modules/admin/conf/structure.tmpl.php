...
(
	...
	(
		...
		"lastrun" => Array("Type" => "datetime", ),
		"nextrun" => Array("Type" => "datetime", ),
	...
	(
		"id" => Array("Type" => "int(10) unsigned", "Index" => "PRIMARY", ),
		"uid" => Array("Type" => "int(10) unsigned", "Index" => "1", ),
		"dte_deb" => Array("Type" => "datetime", ),
		"dte_fin" => Array("Type" => "datetime", ),
		"uid_maj" => Array("Type" => "int(10) unsigned", ),
		"dte_maj" => Array("Type" => "datetime", ),
	),
	"document" => Array
	...
	(
		...
		"paye" => Array("Type" => "enum('oui','non')", "Default" => "non", ),
		"actif" => Array("Type" => "enum('oui','non')", "Default" => "oui", "Index"=>1 ),
		"dte_create" => Array("Type" => "datetime", ),
	...
	(
		...
		"forum_date" => Array("Type" => "datetime", ),
	),
	"groupe" => Array
	(
	...
	(
		...
		"idcpt" => Array("Type" => "int(10) unsigned", "Index" => "1"),
		...
		"dte_inscription" => Array("Type" => "date", ),
		"dte_login" => Array("Type" => "datetime", ),
