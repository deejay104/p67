			...
			foreach($tresa as $r)
			  {
					...
					$input_arrays[$ii]["description"]=sql2time($resa["resa"]->dte_deb,"nosec").utf8_encode(" � ").sql2time($resa["resa"]->dte_fin,"nosec")."<br>".utf8_encode($resa["pilote"]->Aff("fullname","val")).(($resa["instructeur"]->uid>0) ? "<br/>+ ".utf8_encode($resa["instructeur"]->Aff("fullname","val")) : "").(($resa["resa"]->description!="") ? "<br>----<br>".utf8_encode($resa["resa"]->description) : "");
